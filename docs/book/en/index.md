...
In `v1.0.0`, key semantics for the Effect Program, Turn settlement, Todo completion, quota delivery
...
on current `main` as the direction for later stages, not as shipped `v1.0.0` behavior.
