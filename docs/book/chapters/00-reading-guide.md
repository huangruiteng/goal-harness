...
`v1.0.0` 不是“已经把 LoopX 全部重写成 TypeScript”。当前发布基线是：
...
| Operator surface | Personal Workspace 已提供 Goal、Task、Chat 和 read-only status source 入口；界面不是新的事实源 | [Dashboard README](https://github.com/huangruiteng/loopx/blob/v1.0.0/apps/presentation/dashboard/README.md) |
