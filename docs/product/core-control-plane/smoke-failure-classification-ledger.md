...
| `examples/session_runtime/session-runtime-control-plane-adapter-doc-smoke.py` | Red | Green | release packaging / docs dependency | Packaging gap. The installed release did not contain `docs/development/contributor-tasks.md`, while the source checkout did. | P2 | Either install the contributor task doc with release snapshots or make the smoke use a shipped public doc. |
