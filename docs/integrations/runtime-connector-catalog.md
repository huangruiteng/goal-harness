...
by `examples/external-scheduler-worker-smoke.py`. The thin scheduler-hint
consumer parity contract with Pi is guarded by
`tests/test_host_loop_runtime_parity.py`.
