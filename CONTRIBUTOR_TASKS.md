...
- public docs under `docs/`, especially the state interaction model, status
  ...
  the hierarchical stride, post-outcome memory utility, human-attention, and
  TypeScript migration RFCs, the Dev Book and control-plane course, and the
