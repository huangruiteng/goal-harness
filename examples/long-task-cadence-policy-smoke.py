...
def main() -> int:
    ...
    for required in [
        ...
        "`delivery_outcome` is a claim bounded by the same metadata",
        "remain `surface_only` even when a caller submits",
        "prefers an existing non-surface executable advancement Todo",
        "not a new artifact replay gate",
