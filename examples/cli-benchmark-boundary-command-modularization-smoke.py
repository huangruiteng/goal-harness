...
def main() -> int:
    ...
    assert_contains(boundary_source, "BENCHMARK_TOOLKIT_COMMANDS")
    if "split-control-execution-seam" in boundary_source:
        raise AssertionError("legacy split-control code leaked into the active toolkit CLI")
