...
assert.match(styles, /personal-task-card > button > strong { font-size: 14px; font-weight: 500; line-height: 1.6/, "LoopX task cards use readable medium-weight typography");
